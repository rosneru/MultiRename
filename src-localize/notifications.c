...
void printNotifications(struct List *pList)
{
  ...
  {
    Printf("tr(pApp->pLocaleInfo, MSG_LOG_WRONG_PATHS) count);
  ...
  {
    Printf(
      "tr(pApp->pLocaleInfo, MSG_LOG_OVERLONG_PATHS)
      count);
  ...
  {
    Printf("tr(pApp->pLocaleInfo, MSG_LOG_DATESTAMP)           "split into parts:\n",
      count);
  ...
  {
    Printf(
      "tr(pApp->pLocaleInfo, MSG_LOG_EXAMINE) count);
  ...
  {
    Printf("tr(pApp->pLocaleInfo, MSG_LOG_LOCK) count);
  ...
  {
    Printf(
      "tr(pApp->pLocaleInfo, MSG_LOG_LINKS) count);
  ...
  {
    Printf("tr(pApp->pLocaleInfo, MSG_LOG_ALREADY_IN_LST)           "list:\n",
      count);
