/*
**	This file generated by localize 2.9 (AmigaDOS 2.1) from src/range_select_window.c
*/
...
RangeSelectWindow *createRangeSelectWindow(struct Screen *pScreen)
{
  ...
  pMainLayout = NewObject(LAYOUT_GetClass(), NULL,
    ...
    CHILD_Label, m_ppGadgets[GID_LABEL_LONGEST_ITEM] = NewObject(LABEL_GetClass(), NULL,
      ...
      LABEL_Text, (ULONG)"tr(pApp->pLocaleInfo, MSG_LONGEST_ITEM)
      TAG_DONE),
    ...
    TAG_DONE),
    CHILD_Label, NewObject(LABEL_GetClass(), NULL, LABEL_Text, (ULONG)"tr(pApp->pLocaleInfo, MSG_FROM) TAG_DONE),
    LAYOUT_AddChild, m_ppGadgets[GID_SLI_TO] = NewObject(SLIDER_GetClass(), NULL,
      ...
      SLIDER_DispHook, &m_SlidersHook,
    TAG_DONE),
    CHILD_Label, NewObject(LABEL_GetClass(), NULL, LABEL_Text, (ULONG)"tr(pApp->pLocaleInfo, MSG_TO) TAG_DONE),
    LAYOUT_AddChild, m_ppGadgets[GID_STRING_RESULT_NAME] = NewObject(STRING_GetClass(), NULL,
      ...
      GA_TabCycle, TRUE,
    TAG_DONE),
    CHILD_Label, NewObject(LABEL_GetClass(), NULL, LABEL_Text, (ULONG)"tr(pApp->pLocaleInfo, MSG_SELECTION_RESULT) TAG_DONE),
    LAYOUT_AddChild, m_ppGadgets[GID_STRING_RESULT_MASK] = NewObject(STRING_GetClass(), NULL,
      ...
      GA_TabCycle, TRUE,
    TAG_DONE),
    CHILD_Label, NewObject(LABEL_GetClass(), NULL, LABEL_Text, (ULONG)"tr(pApp->pLocaleInfo, MSG_RESULT_MASK) TAG_DONE),
    LAYOUT_AddChild, NewObject(LAYOUT_GetClass(), NULL,
      ...
      LAYOUT_AddChild, m_ppGadgets[GID_BTN_OK] = NewObject(BUTTON_GetClass(), NULL,
        GA_ID, GID_BTN_OK,
        GA_RelVerify, TRUE,
        GA_Text, (ULONG)"tr(pApp->pLocaleInfo, MSG_OK_GAD)
      ...
      LAYOUT_AddChild, m_ppGadgets[GID_BTN_CANCEL] = NewObject(BUTTON_GetClass(), NULL,
        ...
        GA_RelVerify, TRUE,
        GA_Text, (ULONG)"tr(pApp->pLocaleInfo, MSG_CANCEL_GAD)
        BUTTON_TextPadding, TRUE,
      TAG_DONE),
      CHILD_WeightedWidth, 0,
    TAG_DONE),
