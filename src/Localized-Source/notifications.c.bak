/*
**	This file generated by localize 2.9 (AmigaDOS 2.1) from src/notifications.c
*/
// clang-format off
#ifdef __clang__
...
void printNotifications(struct List *pList)
{
  ...
  {
    Printf("tr(pApp->pLocaleInfo, MSG_LOG_SELECTED_PATH) pNode->ln_Name);
  }

  if (0 < (count = getNotificationCountByType(pList, NNT_SKIPPED_WRONG_PATH)))
  {
    Printf("tr(pApp->pLocaleInfo, MSG_LOG_SKIPPED_WRONG_PATHS) count);
  ...
  {
    Printf(
      "tr(pApp->pLocaleInfo, MSG_LOG_SKIPPED_OVERLONG_PATHS)
      count);
  ...
  {
    Printf("tr(pApp->pLocaleInfo, MSG_LOG_SKIPPED_DATESTAMP)           "split into parts:\n",
      count);
  ...
  {
    Printf(
      "tr(pApp->pLocaleInfo, MSG_LOG_SKIPPED_EXAMINE) count);
  ...
  {
    Printf("tr(pApp->pLocaleInfo, MSG_LOG_SKIPPED_LOCK) count);
  ...
  {
    Printf(
      "tr(pApp->pLocaleInfo, MSG_LOG_SKIPPED_LINKS) count);
  ...
  {
    Printf("tr(pApp->pLocaleInfo, MSG_LOG_SKIPPED_ALREADY_IN_LIST)           "list:\n",
      count);
  ...
  {
    Printf("tr(pApp->pLocaleInfo, MSG_LOG_RENAME_FAILED) count);
